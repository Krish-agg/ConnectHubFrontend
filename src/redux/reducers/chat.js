    ...
    reducers:{
        ...
        setNewMessagesAlert:(state,action)=>{
            ...
            if(index !==-1){
                ...
                state.newMessageAlert.push({chatId:action.payload.chatId,
                    count:1,
                })
            }
        },
...
export const {increamentNotification,resetNotification,setNewMessagesAlert,removeNewMessageAlert}=chatSlice.actions;
